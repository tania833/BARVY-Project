...
import styles from '../css.modules/HowItWorks.module.scss';
                ...
                <div className={styles.letsStart__container}>
                    <div className={styles.letsStart__card}>
                        ...
                        <div className={styles.letsStart__icon}>
                            <img className={styles.letsStart__img}
                                src="https://i.imgur.com/hDb15qV.png"
                                alt="icon1" /></div>
                        <div className={styles.letsStart__text}>Вибери курс чи урок, що сподобався або викладача, у якого хочеш навчатись</div>
                    </div>
                    <div className={styles.letsStart__card}>
                        ...
                        <div className={styles.letsStart__text}>Ознайомся з описом курсу, демо відео та викладачем</div>
                    </div>
                    <div className={styles.letsStart__card}>
                        ...
                        <div className={styles.letsStart__text}>Швидка реєстрація та оплата зручним способом</div>
                    </div>
                    <div className={styles.letsStart__card}>
                        ...
                        <div className={styles.letsStart__text}>Дивись курс в особистому кабінеті та  твори!</div>
                    </div>
                </div>
            </div>
        </div>
